...
class ProductResourceIT {
    ...
    private static final Integer DEFAULT_PROD_ID = 1;
    private static final Integer UPDATED_PROD_ID = 2;
    ...
    public static Product createEntity() {
        Product product = new Product().prodId(DEFAULT_PROD_ID).prodName(DEFAULT_PROD_NAME).price(DEFAULT_PRICE);
        return product;
    }
    ...
    public static Product createUpdatedEntity() {
        Product product = new Product().prodId(UPDATED_PROD_ID).prodName(UPDATED_PROD_NAME).price(UPDATED_PRICE);
        return product;
    }
    ...
    void createProduct() throws Exception {
        ...
        assertThat(testProduct.getProdId()).isEqualTo(DEFAULT_PROD_ID);
    ...
    void getAllProducts() {
        ...
        webTestClient
            ...
            .jsonPath("$.[*].prodId")
            .value(hasItem(DEFAULT_PROD_ID))
            .jsonPath("$.[*].prodName")
            .value(hasItem(DEFAULT_PROD_NAME))
            .jsonPath("$.[*].price")
    ...
    void getProduct() {
        ...
        webTestClient
            ...
            .jsonPath("$.prodId")
            .value(is(DEFAULT_PROD_ID))
            .jsonPath("$.prodName")
            .value(is(DEFAULT_PROD_NAME))
            .jsonPath("$.price")
    ...
    void putNewProduct() throws Exception {
        ...
        updatedProduct.prodId(UPDATED_PROD_ID).prodName(UPDATED_PROD_NAME).price(UPDATED_PRICE);
        ...
        Product testProduct = productList.get(productList.size() - 1);
        assertThat(testProduct.getProdId()).isEqualTo(UPDATED_PROD_ID);
    ...
    void fullUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.prodId(UPDATED_PROD_ID).prodName(UPDATED_PROD_NAME).price(UPDATED_PRICE);
